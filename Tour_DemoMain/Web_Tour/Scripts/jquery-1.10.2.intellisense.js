...
intellisense.annotate(jQuery, {
  ...
  'support': function() {
    /// <summary>A collection of properties that represent the presence of different browser features or bugs. Primarily intended for jQuery's  use; specific properties may be removed when they are no longer needed ly to improve page startup performance.</summary>
    /// <returns type="Object" />
  },
  'trim': function() {
    /// <signature>
  ...
  'type': function() {
    /// <signature>
    ///   <summary>Determine the  JavaScript [[Class]] of an object.</summary>
    ///   <param name="obj" type="PlainObject">Object to get the  JavaScript [[Class]] of.</param>
    ///   <returns type="String" />
    /// </signature>
  },
  'unique': function() {
